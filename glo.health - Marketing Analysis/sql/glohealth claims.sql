...
WHERE
	...
	-- AND (c.product_name = 'Hair Growth Supplements' OR c.product_name = 'Vitamin B+ Advanced Complex') -- analysing top 2 products claim trends over the months
GROUP BY
	1, 2
ORDER BY 
...
SELECT 
	...
	COUNT(cl.claim_id) AS num_of_claims
FROM 
	glohealth.claims AS cl
JOIN
	glohealth.customers AS cu 
